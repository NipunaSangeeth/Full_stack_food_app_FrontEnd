...
import { setOrders } from "../context/action/ordersAction";
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between">
        <h1 className="text-xl text-headingColour font-semibold">Orders</h1>
        <div className="flex items-center gap-4">
          <p className="flex items-center gap-1 text-textColor">
            Total: <HiCurrencyRupee className="text-lg text-red-500 " />{" "}
            <span className="text-headingColour font-bold">{data?.total}</span>
          </p>

          <p className="px-2 py-[2px] text-sm text-headingColour font-semibold capitalize rounded-md bg-emerald-400 drop-shadow-md">
            {data?.status}
          </p>
          ...
          {admin && (
            <div className="flex items-center justify-center gap-2">
              <p className="text-lg font-semibold text-headingColour">
                Mark As
              </p>
              ...
              <motion.p
                ...
                className={`text-orange-500 text-base font-semibold capitalize border border-r-gray-500 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Preparing
              </motion.p>
              ...
              <motion.p
                ...
                className={`text-red-500 text-base font-semibold capitalize border border-r-gray-500 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Cancelled
              </motion.p>
              ...
              <motion.p
                ...
                className={`text-emerald-500 text-base font-semibold capitalize border border-r-gray-500 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Delivered
              </motion.p>
            </div>
      ...
      <div className="flex items-center justify-start flex-wrap w-full">
            ...
            data.items.map((item, j) => (
              ...
              >
                ...
                <div className="flex items-start flex-col">
                  <p className="text-base font-semibold text-headingColour">
                    {item.product_name}
                  </p>
        ...
        <div className="flex items-start justify-start flex-col gap-2 px-6 ml-auto w-full md:w-460">
          <h1 className="text-lg text-headingColour font-semibold">
            {data.shipping_details.name}
          </h1>
          <p className="text-base text-headingColour -mt-2">
