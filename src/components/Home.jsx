    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col items-start justify-start gap-6">
        <div className="px-4 py-1 flex items-center justify-center gap-2 bg-orange-100 rounded-full">
          ...
          <div className="w z-10 h-10 flex items-center justify-center rounded-full bg-primary shadow-md">
            <img
              src={Delivery}
              alt=""
        ...
        <p className="text-[40px] text-headingColour md:text-[72px] font-sans font-extrabold tracking-wide">
          The Fastest Delivery <span className="text-blue-600">Your City </span>
        </p>
        <p>
          Doloremque eaque veritatis eligendi quisquam, corrupti non commodi,
          quod adipisci cumque ratione, voluptates sunt laudantium! Alias,
          minus. Tempore fuga velit, tenetur animi porro distinctio hic quas.
          Tempora, aperiam illo. Nobis, expedita.
        </p>
        <motion.button
          {...buttonClick}
          className="bg-gradient-to-bl from-blue-400 to-blue-600 px-4 py-2 rounded-xl text-black text-base font-semibold"
        >
          Order Now{" "}
        </motion.button>
      </div>
          ...
          {randomData &&
            randomData.map((data, i) => (
              ...
              >
                ...
                <p className="text-sm font-semibold text-headingColour ">
